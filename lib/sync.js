...
_.extend(Sync.prototype, {
  ...
  insert: Promise.method(function() {
    ...
    console.log('insert data ', syncing.format(_.extend(Object.create(null), syncing.attributes)))
    if(supportsReturning(this.query.client.config)){
      ...
      for (const [key, value] of entries) {
        ...
        // console.log('the value',attributes[key])
        // console.log(typeof attributes[key]);
