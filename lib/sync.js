...
_.extend(Sync.prototype, {
  ...
  insert: Promise.method(function() {
    ...
    var attributes = syncing.format(_.extend(Object.create(null), syncing.attributes))
    console.log('attributes: ', attributes)
    console.log('it is a : ', typeof attributes)

    const entries = Object.entries(attributes)
    for (const [key, value] of entries) {
      console.log(`the key ${key} has a valeu ${value}`)
      if(value == ''){
        attributes[key] = ' '
      }
    }
    ...
    if(supportsReturning(this.query.client.config)){
      ...
      console.log('new insert', new_insert)
